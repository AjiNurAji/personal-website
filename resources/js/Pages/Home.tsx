...
function HeroIllustration() {
    ...
    return (
        <div className="relative mt-10 min-h-[260px] sm:mt-0 sm:min-h-0" aria-label="Interactive abstract technology illustration">
            ...
            <motion.p key={activeLayer} initial={{ opacity: 0, y: 4 }} animate={{ opacity: 1, y: 0 }} className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-full whitespace-nowrap pt-2 text-[11px] text-zinc-400 sm:block">{layerCopy[activeLayer]}</motion.p>
        </div>
    );
}
